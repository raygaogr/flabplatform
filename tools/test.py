...
if __name__ == '__main__':
    txt_path = 'datasets/coco8/labels/val'
    image_path = 'datasets/coco8/images/val'
    output_dir = 'datasets/coco8/labels/val'
    ...
    convert_txt_to_labelme_json(txt_path, image_path, output_dir, yolo_class_name)