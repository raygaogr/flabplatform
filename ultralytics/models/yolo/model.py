...
from flabplatform.flabdet.utils.yolos import YOLO_ROOT, yaml_load


class YOLO(Model):
    """YOLO (You Only Look Once) object detection model."""

    def __init__(self, model="yolo11n.pt", task=None, verbose=True):
        """
...
class YOLOWorld(Model):
    ...
    def __init__(self, model="yolov8s-world.pt", verbose=False) -> None:
        ...
        if not hasattr(self.model, "names"):
            self.model.names = yaml_load(YOLO_ROOT / "cfg/datasets/coco8.yaml").get("names")
