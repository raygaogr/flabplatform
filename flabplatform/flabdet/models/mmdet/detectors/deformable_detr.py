...
from flabplatform.flabcv.cnn.bricks.transformer import MultiScaleDeformableAttention
from mmengine.model import xavier_init
from torch import Tensor, nn
from torch.nn.init import normal_

from flabplatform.flabdet.registry import MODELS
from flabplatform.flabdet.utils.mmdet.structures import OptSampleList
...
class DeformableDETR(DetectionTransformer):
    ...
    def pre_transformer(
        ...
        in `flabplatform.flabdet/detector/base_detr.py`.
    ...
    def pre_decoder(self, memory: Tensor, memory_mask: Tensor,
        ...
        if self.as_two_stage:
            ...
            # See https://github.com/open-mmlab/mmdetection/blob/master/flabplatform.flabdet/models/dense_heads/deformable_detr_head.py#L241 # noqa
