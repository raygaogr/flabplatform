...
from flabplatform.flabdet.utils.mmdet.structures.bbox import BaseBoxes, cat_boxes
from flabplatform.flabdet.utils.mmdet import util_mixins
from flabplatform.flabdet.utils.mmdet.util_random import ensure_rng
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from flabplatform.flabdet.models.mmdet.task_modules.assigners import AssignResult
        from flabplatform.flabdet.models.mmdet.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
