...
from flabplatform.flabdet.utils.mmdet.structures.bbox import BaseBoxes, HorizontalBoxes, get_box_tensor
...
def onnx_delta2bbox(rois: Tensor,
    ...
    if clip_border and max_shape is not None:
        ...
        if torch.onnx.is_in_onnx_export():
            from flabplatform.flabdet.core.export import dynamic_clip_for_onnx
