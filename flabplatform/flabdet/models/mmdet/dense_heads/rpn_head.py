...
from flabplatform.flabcv.cnn import ConvModule
...
from flabplatform.flabdet.utils.mmdet.structures.bbox import (cat_boxes, empty_box_as, get_box_tensor,
                                   get_box_wh, scale_boxes)
from flabplatform.flabdet.utils import InstanceList, MultiConfig, OptInstanceList
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, priors) in \
            ...
            if self.use_sigmoid_cls:
                ...
                # remind that we set FG labels to [0] since flabplatform.flabdet v2.0
                # BG cat_id: 1
