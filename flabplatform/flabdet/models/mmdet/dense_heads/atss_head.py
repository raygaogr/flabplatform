...
from flabplatform.flabcv.cnn import ConvModule, Scale
from mmengine.structures import InstanceData
from torch import Tensor

from flabplatform.flabdet.registry import MODELS
from flabplatform.flabdet.utils import (ConfigType, InstanceList, MultiConfig, OptConfigType,
...
class ATSSHead(AnchorHead):
    ...
    def forward_single(self, x: Tensor, scale: Scale) -> Sequence[Tensor]:
        ...
        Args:
            ...
            scale (:obj: `flabplatform.flabcv.cnn.Scale`): Learnable scale module to resize
                the bbox prediction.
