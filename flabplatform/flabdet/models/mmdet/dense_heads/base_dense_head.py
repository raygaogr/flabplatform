...
from flabplatform.flabdet.utils.mmdet.structures.bbox import (cat_boxes, get_box_tensor, get_box_wh,
                                   scale_boxes)
from flabplatform.flabdet.utils import InstanceList, OptMultiConfig
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, score_factor, priors) in \
            ...
            if getattr(self.loss_cls, 'custom_cls_channels', False):
                ...
                # since flabplatform.flabdet v2.0
                # BG cat_id: num_class
                scores = cls_score.softmax(-1)[:, :-1]

            # After https://github.com/open-mmlab/flabplatform.flabdetection/pull/6268/,
