...
import numpy as np
import torch
from flabplatform.flabcv.ops import nms
from flabplatform.core.config import ConfigDict
from torch import Tensor

from flabplatform.flabdet.utils.mmdet.structures.bbox import bbox_mapping_back


# TODO remove this, never be used in flabplatform.flabdet
def merge_aug_proposals(aug_proposals, img_metas, cfg):
    ...
    Args:
        ...
        img_metas (list[dict]): list of image info dict where each dict has:
            ...
            `flabplatform.flabdet/datasets/pipelines/formatting.py:Collect`.
