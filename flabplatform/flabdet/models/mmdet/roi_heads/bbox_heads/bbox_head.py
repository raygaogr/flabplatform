...
from flabplatform.flabdet.models.mmdet.layers import multiclass_nms
from flabplatform.flabdet.models.mmdet.losses import accuracy
from flabplatform.flabdet.models.mmdet.task_modules.samplers import SamplingResult
from flabplatform.flabdet.models.mmdet.utils import empty_instances, multi_apply
from flabplatform.flabdet.registry import MODELS, TASK_UTILS
from flabplatform.flabdet.utils.mmdet.structures.bbox import get_box_tensor, scale_boxes
from flabplatform.flabdet.utils import ConfigType, InstanceList, OptMultiConfig
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, sampling_results: Union[List[SamplingResult],
        ...
        Example:
            ...
            >>> import numpy as np
            >>> from flabplatform.flabdet.models.task_modules.samplers.
            ... sampling_result import random_boxes
            >>> from flabplatform.flabdet.models.task_modules.samplers import SamplingResult
