...
from flabplatform.core.engine import MMRunner
from mmengine.utils import mkdir_or_exist
from mmengine.visualization import Visualizer

from flabplatform.flabdet.datasets.mmdet.samplers import TrackImgSampler
from flabplatform.flabdet.registry import HOOKS
from flabplatform.flabdet.utils.mmdet.structures import DetDataSample, TrackDataSample
from flabplatform.flabdet.utils.mmdet.structures.bbox import BaseBoxes
from flabplatform.flabdet.utils.mmdet.visualization.palette import _get_adaptive_scales
...
class DetVisualizationHook(Hook):
    ...
    def after_val_iter(self, runner: MMRunner, batch_idx: int, data_batch: dict,
        ...
        img = flabplatform.flabcv.imfrombytes(img_bytes, channel_order='rgb')
    ...
    def after_test_iter(self, runner: MMRunner, batch_idx: int, data_batch: dict,
                        outputs: Sequence[DetDataSample]) -> None:
        ...
        for data_sample in outputs:
            ...
            if isinstance(text, str):  # VG
                ...
                if out_file is not None:
                    flabplatform.flabcv.imwrite(drawn_img[..., ::-1], out_file)
                else:
