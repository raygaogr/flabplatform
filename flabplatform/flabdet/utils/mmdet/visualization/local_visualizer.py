...
from flabplatform.flabdet.registry import VISUALIZERS
...
def get_palette(palette: Union[List[tuple], str, tuple],
    ...
    if isinstance(palette, list):
        ...
        from flabplatform.flabdet.datasets.mmdet import CocoDataset, CocoPanopticDataset
        dataset_palette = CocoDataset.METAINFO['palette']
        if len(dataset_palette) < num_classes:
            dataset_palette = CocoPanopticDataset.METAINFO['palette']
    elif palette == 'citys':
        from flabplatform.flabdet.datasets.mmdet import CityscapesDataset
        dataset_palette = CityscapesDataset.METAINFO['palette']
    elif palette == 'voc':
        from flabplatform.flabdet.datasets.mmdet import VOCDataset
        dataset_palette = VOCDataset.METAINFO['palette']
    elif is_str(palette):
        dataset_palette = [flabplatform.flabcv.color_val(palette)[::-1]] * num_classes
    else:
