...
from flabplatform.flabcv.transforms import LoadAnnotations as MMCV_LoadAnnotations
from flabplatform.flabcv.transforms import LoadImageFromFile
from mmengine.fileio import get
from mmengine.structures import BaseDataElement

from flabplatform.flabdet.registry import TRANSFORMS
from flabplatform.flabdet.utils.mmdet.structures.bbox import get_box_type
from flabplatform.flabdet.utils.mmdet.structures.bbox.box_type import autocast_box_type
from flabplatform.flabdet.utils.mmdet.structures.mask import BitmapMasks, PolygonMasks
...
class LoadMultiChannelImageFromFiles(BaseTransform):
    ...
    Args:
        ...
        file_client_args (dict): Arguments to instantiate the
            corresponding backend in flabplatform.flabdet <= 3.0.0rc6. Defaults to None.
        backend_args (dict, optional): Arguments to instantiate the
            corresponding backend in flabplatform.flabdet >= 3.0.0rc7. Defaults to None.
    """
    ...
    def transform(self, results: dict) -> dict:
        ...
        Args:
            results (dict): Result dict from :obj:`flabplatform.flabdet.CustomDataset`.
        ...
        for name in results['img_path']:
            ...
            img.append(
                flabplatform.flabcv.imfrombytes(
                    img_bytes,
...
class LoadAnnotations(MMCV_LoadAnnotations):
    ...
    Args:
        ...
        imdecode_backend (str): The image decoding backend type. The backend
            argument for :func:``flabplatform.flabcv.imfrombytes``.
            See :fun:``flabplatform.flabcv.imfrombytes`` for details.
            Defaults to 'cv2'.
        backend_args (dict, optional): Arguments to instantiate the
    ...
    def _load_labels(self, results: dict) -> None:
        ...
        # TODO: Inconsistent with flabplatform.flabcv, consider how to deal with it later.
    ...
    def _load_seg_map(self, results: dict) -> None:
        ...
        Args:
            results (dict): Result dict from :obj:``flabplatform.flabcv.BaseDataset``.
        ...
        gt_semantic_seg = flabplatform.flabcv.imfrombytes(
...
class LoadPanopticAnnotations(LoadAnnotations):
    ...
    def _load_masks_and_semantic_segs(self, results: dict) -> None:
        ...
        img_bytes = get(
            results['seg_map_path'], backend_args=self.backend_args)
        pan_png = flabplatform.flabcv.imfrombytes(
...
class InferencerLoader(BaseTransform):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.from_ndarray = TRANSFORMS.build(
            dict(type='flabplatform.flabdet.LoadImageFromNDArray', **kwargs))
...
class LoadTrackAnnotations(LoadAnnotations):
    ...
    def _load_instances_ids(self, results: dict) -> None:
        ...
        Args:
            results (dict): Result dict from :obj :obj:``flabplatform.flabcv.BaseDataset``.
