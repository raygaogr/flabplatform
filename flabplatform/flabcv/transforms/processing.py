...
class Normalize(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        results['img'] = flabplatform.flabcv.imnormalize(results['img'], self.mean, self.std,
                                          self.to_rgb)
...
class Pad(BaseTransform):
    ...
    def _pad_img(self, results: dict) -> None:
        ...
        padded_img = flabplatform.flabcv.impad(
            results['img'],
            shape=size,
            pad_val=pad_val,
    ...
    def _pad_seg(self, results: dict) -> None:
        ...
        if results.get('gt_seg_map', None) is not None:
            ...
            results['gt_seg_map'] = flabplatform.flabcv.impad(
                results['gt_seg_map'],
...
class CenterCrop(BaseTransform):
    ...
    def _crop_img(self, results: dict, bboxes: np.ndarray) -> None:
        ...
        """
        if results.get('img', None) is not None:
            img = flabplatform.flabcv.imcrop(results['img'], bboxes=bboxes)
    ...
    def _crop_seg_map(self, results: dict, bboxes: np.ndarray) -> None:
        ...
        """
        if results.get('gt_seg_map', None) is not None:
            img = flabplatform.flabcv.imcrop(results['gt_seg_map'], bboxes=bboxes)
    ...
    def __init__(
        ...
        **resize_kwargs,
        ...
        if isinstance(scales, list):
            ...
            self.scales = [scales]
        assert mmengine.is_seq_of(self.scales, (tuple, int, list))
...
class RandomFlip(BaseTransform):
    ...
    def _flip_seg_map(self, seg_map: dict, direction: str) -> np.ndarray:
        ...
        """
        seg_map = flabplatform.flabcv.imflip(seg_map, direction=direction)
