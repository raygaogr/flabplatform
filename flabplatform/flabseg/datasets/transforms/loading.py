...
from flabplatform.flabcv.transforms import LoadAnnotations as CV_LoadAnnotations
from flabplatform.flabcv.transforms import LoadImageFromFile

from flabplatform.flabseg.registry import TRANSFORMS
from flabplatform.flabseg.utils import datafrombytes
...
class LoadAnnotations(CV_LoadAnnotations):
    ...
    def transform(self, results: dict) -> Optional[dict]:
        ...
        try:
            if Path(filename).suffix in ['.npy', '.npz']:
                ...
                img = flabplatform.flabcv.imfrombytes(
                    img_bytes,
