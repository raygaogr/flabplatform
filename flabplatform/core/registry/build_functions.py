...
def build_from_cfg(
    ...
    Examples:
        >>> from  import Registry, build_from_cfg
    ...
    if not isinstance(registry, Registry):
        raise TypeError('registry must be a flabplatform.utils.registry object, '
        ...
        if isinstance(obj_type, str):
            ...
            if obj_cls is None:
                raise KeyError(
                    ...
                    'correct or it was registered as expected.'  # noqa: E501
                )
...
def build_runner_from_cfg(cfg: Union[dict, ConfigDict, Config],
    ...
    Examples:
        >>> from flabplatform.utils.registry import Registry, build_runner_from_cfg
    ...
    assert isinstance(
        registry, Registry), ('registry should be a flabplatform.utils.registry object',
                              f'but got {type(registry)}')
