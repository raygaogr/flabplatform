...
from flabplatform.flabdet.registry import TRAINERS
from flabplatform.flabdet.models import ClassificationModel
...
from flabplatform.flabcls.validation import ClassificationValidator
from flabplatform.flabdet.train import BaseTrainer
...
class ClassificationTrainer(BaseTrainer):
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        ...
        for m in model.modules():
            if not self.args.pretrained and hasattr(m, "reset_parameters"): # TODO 确认这一步是否存在bug。
                m.reset_parameters()
